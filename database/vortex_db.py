...
class VortexDB:
    ...
    def write_categorised_transactions(self, transactions: CategorizedTransactions):

        def trans_to_row(t: CategorizedTransaction):
    ...
    def read_transactions(self) -> CategorizedTransactions:
    ...
    def initialize(self):
        sql = """CREATE TABLE IF NOT EXISTS categorised_transactions 
                    (id INTEGER PRIMARY KEY, category TEXT, account TEXT, payment_date TEXT, payee TEXT, amount TEXT )"""
