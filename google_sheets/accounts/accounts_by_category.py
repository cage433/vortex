...
class AccountsByCategoryRange(TabRange):
    ...
    (AIRTABLE_ROW, BANK_FEES_ROW,
     DONATION_ROW,
     EQUIPMENT_ROW,
     FIRE_ALARM_ROW, FLOOD_ROW, GRANT_ROW,
     INSURANCE_ROW, KASHFLOW_ROW,
    ...
    def _category_values(self):
        ...
        for row, categories in [
            ...
            (self.SECURITY_ROW, [PayeeCategory.BUILDING_SECURITY, PayeeCategory.GIG_SECURITY]),
            (self.SOUND_ENGINEER_ROW, [PayeeCategory.SOUND_ENGINEER]),
            (self.PRS_ROW, [PayeeCategory.PRS]),
            (self.MARKETING_ROW, [PayeeCategory.MARKETING]),
            ...
            (self.LICENSING_ROW, [PayeeCategory.LICENSING]),
